...
AddEventHandler('EasyAdmin:SetLanguage', function(newstrings)
	...
	noClipSpeeds = strings.noclipspeeds
end)
...
function spectatePlayer(targetPed,target,name)
	...
	if(enable)then
			...
			TriggerEvent('esx:showNotification','Obserwujesz użytkownika:')
	else
			...
			StopDrawPlayerInfo()
			TriggerEvent('esx:showNotification','Prestałeś obserować użytkownika')
	end
end
